...
class Admin extends Authenticatable 
{
    ...
    {
        return $this->hasOne('App\Models\VendorsBusinessDetail', 'vendor_id', 'vendor_id'); // 'vendor_id' is the foreign key in the vendors_business_details table
    }

    public function vendorBank()
    {
        return $this->hasOne('App\Models\VendorsBankDetail', 'vendor_id', 'vendor_id'); // 'vendor_id' is the foreign key in the vendors_bank_details table
    }
}