                        ...
                        <div class="card-body">
                            ...
                            @if (!empty($vendorDetails['image']))
                                <div class="form-group">
                                    ...
                                    <br>
                                    <img style="width: 200px" src="{{ url('storage/admin/images/photos/' . $vendorDetails['image']) }}">
                                </div>
                            @endif
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            @if (!empty($vendorDetails['vendor_business']['address_proof_image']))
                                <div class="form-group">
                                    ...
                                    <br>
                                    <img style="width: 200px" src="{{ url('storage/admin/images/proofs/' . $vendorDetails['vendor_business']['address_proof_image']) }}">
                                </div>
                            @endif
                        </div>
                    </div>
