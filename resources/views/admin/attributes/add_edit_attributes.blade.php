                            ...
                            <form class="forms-sample" action="{{ url('admin/add-edit-attributes/' . $product['id']) }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    @if (!empty($product['product_image']))
                                        <img style="width: 120px" src="{{ url('/storage/front/images/product_images/small/' . $product['product_image']) }}"> {{--  the 'small' image --}}
                                    @else
                                        <img style="width: 120px" src="{{ url('/storage/front/images/product_images/small/no-image.png') }}"> {{--  the 'small' image --}}
                                    @endif
                                </div>
