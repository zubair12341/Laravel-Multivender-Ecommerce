            ...
            <div class="row row-cols-1">
                <div class="col">
                    <div class="breadcrumb__content text-center">
                        <h1 class="breadcrumb__content--title text-white mb-25">Vender Login/Register</h1>
                        <ul class="breadcrumb__content--menu d-flex justify-content-center">
                            <li class="breadcrumb__content--menu__items"><a class="text-white"
                                    href="index.html">Home</a></li>
                            <li class="breadcrumb__content--menu__items"><span class="text-white">Vender Login/Register</span>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="row row-cols-md-2 row-cols-1">
                        ...
                        <div class="col">
                            <div class="account__login register">
                                ...
                                <form action="{{route('vender.register')}}" method="POST">
@csrf
