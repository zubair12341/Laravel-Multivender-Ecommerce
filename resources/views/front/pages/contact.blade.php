        ...
        <div class="container">
            ...
            <div class="main__contact--area position__relative">
                ...
                <div class="contact__form">
                    ...
                    <form class="contact__form--inner" action="{{ url('contact') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="contact__form--list mb-20">
                                    <label class="contact__form--label" for="input1">Name <span class="contact__form--label__star">*</span></label>
                                    <input class="contact__form--input" name="name" value="{{ old('name') }}" id="input1" placeholder="Your Name" type="text">
                                </div>
                                @error('name')
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="contact__form--list mb-20">
                                    ...
                                    <input class="contact__form--input" name="email" value="{{ old('email') }}" id="input4" placeholder="Email" type="email">
                                </div>
                                @error('email')
                                <span class="text-danger">{{$message}}</span>
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="contact__form--list mb-20">
                                    ...
                                    <input class="contact__form--input" name="subject" value="{{ old('subject') }}" id="input4" placeholder="Subject" type="text">
                                </div>
                                @error('subject')
                                <span class="text-danger">{{$message}}</span>
                            ...
                            <div class="col-12">
                                <div class="contact__form--list mb-15">
                                    ...
                                    <textarea class="contact__form--textarea" name="message"  id="input5" placeholder="Write Your Message">{{old('message')}}</textarea>
                                </div>
                                @error('message')
                                <span class="text-danger">{{$message}}</span>
                    ...
                    <div class="contact__info--items">
                        ...
                        <div class="contact__info--items__inner d-flex">
                            ...
                            <div class="contact__info--content">
                                <p class="contact__info--content__desc text-white"> <a href="tel:+01234-567890">+01234-567890</a>    </p>
                            </div>
                        </div>
                    </div>
                    <div class="contact__info--items">
                        ...
                        <div class="contact__info--items__inner d-flex">
                            ...
                            <div class="contact__info--content">
                                <p class="contact__info--content__desc text-white"> <a href="mailto:info@example.com">info@example.com</a> </p> 
                            </div>
                        </div>
                    </div>
                    <div class="contact__info--items">
