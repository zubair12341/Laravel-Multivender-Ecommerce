...
Route::namespace('App\Http\Controllers\Front')->group(function() {
    ...
    // Vendor Register
    Route::post('vendor/register', 'VendorController@vendorRegister')->name('vender.register'); // the register HTML form submission in vendor login_register.blade.php page
    ...
    Route::post('cart/update', 'ProductsController@cartUpdate')->name('cart.update');

    // Delete a Cart Item AJAX call in front/products/cart_items.blade.php. Check front/js/custom.js
    Route::post('cart/delete', 'ProductsController@cartDelete');

    Route::get('all-cart/delete', 'ProductsController@cartDeleteAll')->name('cart.item.delete');
    ...
    Route::group(['middleware' => ['auth']], function() {
        ...
        Route::get('/online-pay/{id}', 'StripeController@index')->name('online-pay');
        Route::post('/online-pay', 'StripeController@stripePost')->name('stripe.post');
